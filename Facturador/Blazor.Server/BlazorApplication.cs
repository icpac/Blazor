...
using BFact.Blazor.Server.Services;

namespace BFact.Blazor.Server {
    public partial class BFactBlazorApplication : BlazorApplication {
        public BFactBlazorApplication() {
            InitializeComponent();
        }
        protected override void OnSetupStarted() {
            ...
            if(configuration.GetConnectionString("ConnectionString") != null) {
                ...
                ConnectionString = DevExpress.Xpo.DB.PostgreSqlConnectionProvider.GetConnectionString("localhost", "postgres", "postgres123", "BFact");
            }
#if EASYTEST
        ...
        private void BFactBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
